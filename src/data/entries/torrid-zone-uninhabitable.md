...
acceptedApproximately: Influential classical and medieval European climatic geography
acceptedYear: -350
...
sources:
- title: Meteorology, Book II
  url: https://classics.mit.edu/Aristotle/meteorology.2.ii.html
  publisher: Aristotle / Internet Classics Archive
  purpose: Previous belief
  note: Primary text arguing that areas beyond the tropics are uninhabitable because of heat.
- title: The Geography of Strabo, Book II
  url: https://penelope.uchicago.edu/Thayer/E/Roman/Texts/Strabo/2C%2A.html
  publisher: Strabo / LacusCurtius
  purpose: Historical context
  note: Shows ancient disagreement over the torrid zone and points to inhabited hot regions.
- title: What Are the Different Climate Types?
  url: https://www.nesdis.noaa.gov/about/k-12-education/understanding-our-planet/what-are-the-different-climate-types
  publisher: NOAA NESDIS
  purpose: Current evidence
  note: Explains modern climate classification and the warm tropical regions around the equator.
---

The “torrid zone” was a geographical deduction from the geometry of sunlight.
