...
summary: "Der letzte große SI-Standard auf Grundlage eines einzelnen Artefakts wurde durch eine Definition ersetzt, die an eine fundamentale Naturkonstante gebunden ist."
sourceNotes:
- "Beschreibt den internationalen Kilogrammprototyp als frühere Grundlage der Einheit."
- "Erläutert den Wechsel von 2019 vom Metallzylinder zu einer Definition über die Plancksche Konstante."
- "Beschreibt die heutige SI-Definition des Kilogramms."
---

Seit 1889 war das Kilogramm buchstäblich an einen einzelnen Gegenstand gebunden: den Internationalen Kilogrammprototyp, einen Platin-Iridium-Zylinder, der nahe Paris aufbewahrt wurde. Nationale Metrologieinstitute besaßen amtliche Kopien, deren Massen regelmäßig mit dem Prototyp verglichen wurden.

Das System funktionierte bemerkenswert gut, hatte aber eine grundsätzliche Schwäche. Wenn der definierende Körper durch Verunreinigung, Reinigung oder Veränderungen seiner Oberfläche winzige Mengen an Masse gewann oder verlor, existierte kein unabhängiges Kilogramm, mit dem man sagen konnte, dass gerade der Prototyp selbst sich verändert hatte. Vergleiche zwischen ihm und seinen Kopien zeigten im Lauf der Zeit kleine relative Abweichungen.
