...
- title: Malaria
  ...
  note: Identifies malaria as a parasitic disease spread to humans by certain mosquitoes.
- title: Malaria's Impact Worldwide
  url: https://www.cdc.gov/malaria/about/index.html
  publisher: U.S. Centers for Disease Control and Prevention
  purpose: Current evidence
  note: Explains that malaria is caused by Plasmodium parasites transmitted by Anopheles mosquitoes.
...
- title: On Airs, Waters, and Places
  url: https://classics.mit.edu/Hippocrates/airwatpl.7.7.html
  publisher: Hippocrates
  purpose: Previous belief
  note: Primary ancient text linking marshy, stagnant waters with unhealthy conditions and recurrent fevers.
- title: Overview - Malaria
  url: https://www.ncbi.nlm.nih.gov/books/NBK234333/
  publisher: NCBI Bookshelf / National Academies
  purpose: Historical context
  note: Reviews ancient malaria-like descriptions, Hippocrates' association of stagnant water with fever, Roman drainage, and the later 'bad air' terminology.
---
