---
locale: de
entryId: sleep-is-a-passive-shutdown
sourceReviewedAt: '2026-08-20'
claim: Schlaf ist im Wesentlichen ein einheitlicher, passiver Zustand, der durch eine allgemeine Verringerung der Gehirnaktivität entsteht.
currentUnderstanding: Schlaf ist ein aktiv regulierter, hoch organisierter Zustand mit wiederkehrenden Non-REM- und REM-Phasen, unterschiedlichen Mustern neuronaler Aktivität und mehreren physiologischen Funktionen.
whyItChanged: Vor der Aufzeichnung der Hirnaktivität ließ sich Schlaf als weitgehend einheitlicher Rückzug aus dem Wachzustand verstehen. EEG-Studien ab den 1930er-Jahren und die Entdeckung des REM-Schlafs 1953 zeigten wiederkehrende Stadien mit deutlich unterschiedlichen Aktivitätsmustern des Gehirns.
acceptedApproximately: Vor EEG-basierter Schlafstadieneinteilung und der Entdeckung des REM-Schlafs
changedApproximately: 1930er- bis 1950er-Jahre
summary: EEG- und REM-Forschung ersetzten ein einheitliches passives Schlafmodell durch einen aktiv organisierten Zyklus unterschiedlicher Zustände.
sourceNotes:
