---
claim: A properly healing wound should produce pus.
currentUnderstanding: Pus usually indicates an inflammatory response to infection or tissue destruction. Modern wound care aims to prevent or control infection rather than encourage suppuration.
...
- title: On a New Method of Treating Compound Fracture, Abscess, etc.
  ...
  note: Lister's early antiseptic reports argued that excluding putrefactive contamination prevented suppuration and improved outcomes.
- title: The history of wound care
  url: https://pmc.ncbi.nlm.nih.gov/articles/PMC7951499/
  publisher: International Wound Journal
  purpose: Previous belief
  note: Reviews the long history of laudable pus and the transition to antiseptic wound care.
- title: Surgical Site Infection (SSI) Prevention Guideline
  url: https://www.cdc.gov/infection-control/hcp/surgical-site-infection/index.html
  publisher: Centers for Disease Control and Prevention
  purpose: Current evidence
  note: Summarizes modern prevention of surgical-site infection rather than promotion of suppuration.
- title: The mythos of laudable pus along with an explanation for its origin
  url: https://pmc.ncbi.nlm.nih.gov/articles/PMC5538214/
  publisher: International Journal of Infectious Diseases
  purpose: Historical context
  note: Reviews Hippocratic and Galenic wound ideas, medieval dissent, the persistence of laudable-pus doctrine, and its decline with germ theory and antisepsis.
- title: 'Treatment of War Wounds: A Historical Review'
  url: https://pmc.ncbi.nlm.nih.gov/articles/PMC2706344/
  publisher: Clinical Orthopaedics and Related Research
  purpose: Historical context
