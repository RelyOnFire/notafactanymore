---
claim: Planetary and stellar configurations exert physical influences that can cause disease and should guide medical diagnosis, prognosis, and treatment.
currentUnderstanding: Disease arises through biological, genetic, environmental, behavioral, nutritional, toxic, traumatic, and social mechanisms. Planetary positions and zodiacal configurations do not exert clinically meaningful causal effects on disease or determine appropriate treatment.
whyItChanged: Medical astrology lost intellectual authority during the 17th and 18th centuries as anatomy, physiology, chemistry, epidemiology, and experimental medicine developed alternative causal frameworks. Some learned lunar and planetary medical theories nevertheless persisted well into the 19th century.
status: Superseded
category: Medicine
acceptedApproximately: Mainstream late-medieval and early-modern European learned medicine
acceptedYear: 1300
changedApproximately: 17th–19th centuries
timelineYear: 1750
lifespanComparable: false
summary: 'Astrology once sat inside university medicine: physicians used planetary configurations to explain susceptibility, time bloodletting, forecast epidemics, and choose treatments.'
featured: false
publishedAt: '2026-08-13'
reviewedAt: '2026-08-13'
sources:
- title: Astrology, plague, and prognostication in early modern England
  url: https://academic.oup.com/past/article/263/1/81/7044244
  publisher: Past & Present / Oxford Academic
  purpose: Previous belief
  note: Shows that astrological medicine was a central facet of mainstream European medical theory and practice from the late medieval period into the 18th century.
- title: From medical astrology to medical astronomy
  url: https://pubmed.ncbi.nlm.nih.gov/11624340/
  publisher: Social History of Medicine / PubMed
  purpose: Historical context
  note: Explains that astrology lost respect after 1700 but learned lunar and planetary disease theories persisted into the 19th century.
---
