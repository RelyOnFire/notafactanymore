---
locale: de
entryId: water-is-an-element
sourceReviewedAt: '2026-08-13'
claim: Wasser ist ein grundlegendes Element, das nicht in einfachere Stoffe zerlegt werden kann.
currentUnderstanding: Wasser ist eine chemische Verbindung mit der Formel H₂O. Es kann aus Wasserstoff und Sauerstoff gebildet und in diese Elemente zerlegt werden.
whyItChanged: Experimente im späten 18. Jahrhundert erzeugten Wasser durch die Reaktion von Gasen und zerlegten Wasser anschließend in Wasserstoff und Sauerstoff. Damit zeigten sowohl Synthese als auch Analyse, dass Wasser eine Verbindung ist.
acceptedApproximately: Klassische Antike bis ins 18. Jahrhundert
changedApproximately: 1780er-Jahre
summary: Der seit der Antike bestehende Status des Wassers als eines der Grundelemente endete, als Experimente zeigten, dass es eine Verbindung aus Wasserstoff und Sauerstoff ist.
sourceNotes:
...
- Primärtext, der Feuer, Luft, Wasser und Erde als elementare Körper mit jeweils gekoppelten Eigenschaften systematisiert.
